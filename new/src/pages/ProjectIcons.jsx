...
export default function ProjectIcons() {
  ...
  useEffect(() => {
    setProjectsIconKeys(Object.keys(projectIcons));
    setProjectsIconValues(Object.values(projectIcons));

    setInicialStackIconKeys(Object.keys(projectIcons));
    setInicialStackIconValues(Object.values(projectIcons));
  }, []);
    ...
    <div>
      ...
      <main className="">
        ...
        <article className=" h-screen pt-8  mt-16 ml-[340px] px-6 pr-56 max-lg:ml-0 max-lg:pr-6  ">
          ...
          <div className="mt-8">
            <input
              className=" bg-[#70708e33] w-full rounded-lg px-4 py-2 "
            ...
            {finishedTimeout == false ? (
              ...
              projectsIconValues.map((item, index) => {
                return (
                  <Card
                    key={index}
                    item={item}
                    iconKey={projectsIconKeys[index]}
                  />
                );
              })
            ) : (
              <div className="flex flex-col m-auto gap-4">
                <p className="text-xl text-center">
                  ...
                  <a
                    className="flex gap-2 text-[#00979C] justify-center"
                    href="https://github.com/DIGOARTHUR/github-automated-repos/issues/new?assignees=&labels=&template=2-feature-request.yaml"
                  >
                ...
                <img
                  className="h-[350px]"
                  src="https://user-images.githubusercontent.com/59892368/220364871-f553109d-855f-426a-bbe5-5e1c11278003.svg"
                ></img>
              </div>
            )}
          </ul>
