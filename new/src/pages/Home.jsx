...
export default function Home() {
  ...
  return (
    <main className="flex  min-h-screen flex-col items-center m-auto ">
      <Header />
      <div className="max-w-[1200px] min-h-[500px]  grid grid-cols-[1fr_2fr] mt-40 px-6 max-md:flex flex-col ">
        ...
        <div className=" grid grid-rows-[2fr_1fr] max-sm:grid-rows-1 ">
          <div className=" flex-col m-auto max-sm:mb-8">
            <h1 className="text-6xl text-center mb-8 max-md:text-4xl">
              GitHub Automated Repos
            </h1>
            <span className="  text-2xl flex text-center max-md:text-xl">
              Github-automated-repos is the lib that gives you the power to
              manage the visualization of your projects on the website, 
              <br/>
          ...
          <div className="flex justify-around items-start max-sm:flex-col max-sm:mb-12 gap-5">
            <Link
              to="/gettingstart"
              className="  h-[70px] w-[30%] border-2 rounded-full bg-[#737384] flex items-center justify-center max-sm:w-full hover:bg-[#636371]"
            >
              Getting Start
            </Link>
            <Link
      ...
      <div className="bg-gradient-to-r from-[#31313E] to-[#3e3e4b] py-14  flex justify-center items-center w-full  max-md: px-6">
        <div className="  max-w-[1200px]  ">
          ...
          <div className="flex justify-center mb-8">
            <span className="  text-xl self-auto">
              Decide which project will be viewed on your personal page from
              Link keyword determined by you.
            </span>
          </div>
